...
def get_company_narrative(address: str) -> dict:
    ...
    return {
        ...
        "company_narrative": {
            ...
            "ai_analyst_summary": (
                "The company signaled capital constraints with a high-yield bond issuance, "
                "but recent leveraged buying suggests potential insider confidence in upcoming milestones."
            ),
        },
    }
